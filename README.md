...
Bu proje; ASP.NET MVC mimarisi üzerine kurulu, CesiumJS kütüphanesi ile 3D harita görselleştirmesi sunan ve gerçek zamanlı uçuş simülasyonu gerçekleştiren kapsamlı bir Coğrafi Bilgi Sistemi (CBS) uygulamasıdır. Kullanıcılar, 3D modelleri (.glb) harita üzerinde konumlandırabilir, karmaşık rotalar oluşturabilir ve bu süreçlerin sonunda profesyonel raporlar alabilirler.
